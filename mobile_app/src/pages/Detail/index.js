...
export default function Detail(){
    ...
    const message = `Hi ${incident.name}, I would like to offer myself to help.The asked amount/service ${incident.value} I'm in mesure to provide for the case ${incident.title}.`
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.incident}>
                ...
                <Text style={styles.incidentProperty}> Summary </Text>
